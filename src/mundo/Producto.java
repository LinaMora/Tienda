...
public class Producto {
    ...
    public double  calcularPrecioFinal() {
        return this.valorUnitario + (this.valorUnitario*darIVA()/100);
    }
    /**
    ...
    public double darIVA() {
        if(this.darTipo().equalsIgnoreCase("papeleria")){
            return 16.0;
        } else if (this.darTipo().equalsIgnoreCase("supermercado")){
            return 4.0;
        } else {
            return 12.0;
        }
    ...
    public int vender(int pCantidad) {
        ...
        if(this.cantidadBodega < 0){
            int unidades = (this.cantidadBodega+pCantidad);
            this.cantidadBodega = 0;
            this.cantidadUnidadesVendidas += unidades;
            return unidades;
        }
        this.cantidadUnidadesVendidas += pCantidad;
        return pCantidad;
    }
